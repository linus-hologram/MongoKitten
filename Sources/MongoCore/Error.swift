...
public struct MongoProtocolParsingError: Error, Codable, CustomStringConvertible {
    ...
    public internal(set) var description = "An error occurred while parsing a MongoMessage"
...
public struct MongoProtocolSerializationError: Error, Codable, CustomStringConvertible {
    ...
    public let reason: Reason
    public internal(set) var description = "An error occurred while serializing a MongoMessage"
...
public struct MongoInvalidUriError: Error, Codable, CustomStringConvertible {
    ...
    public let reason: Reason
    public internal(set) var description = "The given MongoDB connection URI is invalid"
}
